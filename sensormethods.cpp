...
#define BUMP_BACK_LEFT FEHIO::P2_1//INSERT BUMP PINS
#define BUMP_BACK_RIGHT FEHIO::P2_0//INSERT BUMP PINS
#define CDS_CELL FEHIO::P1_0//FEHIO::P0_0 INSERT CDS CELLS PINS
...
double lightThresholdBlue = 1.719;
double lightThresholdBlueTolerance=.007;
double lightThresholdRed = 0.382;
double lightThresholdRedTolerance=.7;
double lightThresholdNone= 3.281;
double lightThresholdNoneTolerance= .002;
...
bool isBackPressed()
{
    LCD.WriteLine(bumpBackLeft.Value());
    LCD.WriteLine(bumpBackRight.Value());
    return (!bumpBackLeft.Value() && !bumpBackRight.Value());
}
